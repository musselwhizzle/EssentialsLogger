...
/**
 * The AbstractBinderServiceLogger should be used by subclass it and setting a Logger. 
 * That's a bout it. This class takes care of setting up the binders and handling 
 * the incoming messages. 
 */
abstract public class AbstractBinderServiceLogger extends Service implements Logger {
	
	private Logger logger;
	private final LoggingBinder binder = new LoggingBinder();
	
	public AbstractBinderServiceLogger() {
		super();
	}
	...
	public class LoggingBinder extends Binder implements LoggerBinder {
		...
		public Logger getLogger() {
			return AbstractBinderServiceLogger.this;
		}
	}
